  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhengmingcailiao" label="证明材料" prop="zhengmingcailiao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zhengmingcailiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="家庭情况" prop="jiatingqingkuang">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiatingqingkuang" label="家庭情况" prop="jiatingqingkuang">
                    <span>{{ruleForm.jiatingqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="收入情况" prop="shouruqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="收入情况"
                  v-model="ruleForm.shouruqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shouruqingkuang" label="收入情况" prop="shouruqingkuang">
                    <span>{{ruleForm.shouruqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingqingkuang = true;
          ...
          if(o=='shouruqingkuang'){
            this.ruleForm.shouruqingkuang = obj[o];
	    this.ro.shouruqingkuang = true;
            continue;
          }
