<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院校编号" prop="yuanxiaobianhao">
          <el-input v-model="ruleForm.yuanxiaobianhao" 
              placeholder="院校编号" clearable  :readonly="ro.yuanxiaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院校编号" prop="yuanxiaobianhao">
              <el-input v-model="ruleForm.yuanxiaobianhao" 
                placeholder="院校编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院校名称" prop="yuanxiaomingcheng">
          <el-input v-model="ruleForm.yuanxiaomingcheng" 
              placeholder="院校名称" clearable  :readonly="ro.yuanxiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院校名称" prop="yuanxiaomingcheng">
              <el-input v-model="ruleForm.yuanxiaomingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院校类型" prop="yuanxiaoleixing">
          <el-input v-model="ruleForm.yuanxiaoleixing" 
              placeholder="院校类型" clearable  :readonly="ro.yuanxiaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院校类型" prop="yuanxiaoleixing">
              <el-input v-model="ruleForm.yuanxiaoleixing" 
                placeholder="院校类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院校地址" prop="yuanxiaodizhi">
          <el-input v-model="ruleForm.yuanxiaodizhi" 
              placeholder="院校地址" clearable  :readonly="ro.yuanxiaodizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院校地址" prop="yuanxiaodizhi">
              <el-input v-model="ruleForm.yuanxiaodizhi" 
                placeholder="院校地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	lianxidianhua : false,
      ...
      rules: {
          yuanxiaobianhao: [
                { required: true, message: '院校编号不能为空', trigger: 'blur' },
          ],
          yuanxiaomingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yuanxiaobianhao'){
            this.ruleForm.yuanxiaobianhao = obj[o];
	    this.ro.yuanxiaobianhao = true;
            continue;
          }
	    ...
	    this.ro.yuanxiaomingcheng = true;
          ...
          if(o=='yuanxiaoleixing'){
            this.ruleForm.yuanxiaoleixing = obj[o];
	    this.ro.yuanxiaoleixing = true;
            continue;
          }
          if(o=='yuanxiaodizhi'){
