...
def xuesheng_resetPass(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        records=xuesheng.getbyparams(xuesheng, xuesheng, recordsParam)
        if len(records)<1:
            msg['code'] = 400
            msg['msg'] = '用户不存在'
            return JsonResponse(msg)
...
def xuesheng_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/django70090/xuesheng/notify',
            #notify_url=''
        )
...
def xuesheng_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/django70090/admin/dist/index.html#/xuesheng')
